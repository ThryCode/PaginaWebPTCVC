...
<head>
    ...
    <script>(function(){var m=document.querySelector('meta[name="viewport"]'),w=1200,s=window.innerWidth||document.documentElement.clientWidth,t='ontouchstart' in window||navigator.maxTouchPoints>0;if(t&&s<w){var r=s/w;m.setAttribute('content','width='+w+', initial-scale='+r+', maximum-scale='+r+', minimum-scale='+r+', user-scalable=no')}})();</script>
    <title>pctvc</title>
