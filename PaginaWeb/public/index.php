...
?>
        ...
        <section class="carousel" id="carousel">
            ...
            <button class="carousel-arrow prev" id="carouselPrev" aria-label="Anterior">
                <svg aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" width="20" height="20"><path d="M15 18l-6-6 6-6" stroke-linecap="round" stroke-linejoin="round"/></svg>
            </button>
            <button class="carousel-arrow next" id="carouselNext" aria-label="Siguiente">
                <svg aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" width="20" height="20"><path d="M9 18l6-6-6-6" stroke-linecap="round" stroke-linejoin="round"/></svg>
            </button>
            ...
            <div class="sectors-container">
                <div class="sectors-grid">
                    <div class="sector-card animate-scale-in">
                        <div class="sector-icon"><svg aria-hidden="true" width="40" height="40" fill="none" stroke="#2563eb" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h1.5m-1.5 3h1.5m-1.5 3h1.5m3-6H15m-1.5 3H15m-1.5 3H15M9 21v-3.375c0-.621.504-1.125 1.125-1.125h3.75c.621 0 1.125.504 1.125 1.125V21"/></svg></div>
                        <h4>Sector Empresarial</h4>
                    </div>
                    <div class="sector-card animate-scale-in delay-1">
                        <div class="sector-icon"><svg aria-hidden="true" width="40" height="40" fill="none" stroke="#8b5cf6" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 3L1 9l11 6 9-4.91V17h2V9L12 3z"/><path stroke-linecap="round" stroke-linejoin="round" d="M5 13v4c0 1.1 3.134 2 7 2s7-.9 7-2v-4"/></svg></div>
                        <h4>Sector del Conocimiento</h4>
                    </div>
                    <div class="sector-card animate-scale-in delay-2">
                        <div class="sector-icon"><svg aria-hidden="true" width="40" height="40" fill="none" stroke="#f97316" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-1.5 12V10.332A48.36 48.36 0 0 0 12 9.75c-2.551 0-5.056.2-7.5.582V21M3 21h18M12 6.75h.008v.008H12V6.75Z"/></svg></div>
                        <h4>Sector Gubernamental</h4>
                    </div>
                    <div class="sector-card animate-scale-in delay-3">
                        <div class="sector-icon"><svg aria-hidden="true" width="40" height="40" fill="none" stroke="#eab308" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 0 0 1.5-.189m-1.5.189a6.01 6.01 0 0 1-1.5-.189m3.75 7.478a12.06 12.06 0 0 1-4.5 0m3.75 2.383a14.406 14.406 0 0 1-3 0M14.25 18v-.192c0-.983.658-1.823 1.508-2.316a7.5 7.5 0 1 0-7.517 0c.85.493 1.509 1.333 1.509 2.316V18"/></svg></div>
                        <h4>Emprendedores</h4>
                    </div>
                </div>
                    ...
                    <div class="solution-card-wrapper" style="transition-delay:0ms">
                        <div class="solution-card-inner">
                            <div class="solution-icon-wrap">
                                <svg aria-hidden="true" viewBox="0 0 64 64" class="solution-svg">
            ...
            <div class="container">
                ...
                <div class="ventajas-grid">
                    ...
                    <div class="ventaja-card animate-fade-right delay-1">
                        ...
                        <h3>Facilitación de importaciones</h3>
        ...
        <section class="opiniones-section">
            <div class="container">
                ...
                <div class="opiniones-wrapper">
                    ...
                    <div class="opiniones-carousel" aria-label="Carrusel de opiniones" aria-roledescription="carousel">
